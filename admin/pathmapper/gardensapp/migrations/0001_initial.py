# -*- coding: utf-8 -*-
# Generated by Django 1.9.8 on 2016-08-01 01:34
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('collection', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='gardensapp.Collection')),
                ('plant', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='gardensapp.Plant')),
            ],
        ),
        migrations.CreateModel(
            name='Track',
            fields=[
                ...
                ('description', models.TextField(blank=True, max_length=500, null=True)),
                ('waypoints', django.contrib.gis.db.models.fields.LineStringField(srid=4326)),
